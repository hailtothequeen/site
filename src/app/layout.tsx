        ...
        <header className="bg-brand-navy text-white">
          <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              <img src="/logo.svg" alt="Hail to the Queen" className="h-8 w-auto" />
              <span className="sr-only">Hail to the Queen LLC</span>
            </Link>
            <nav className="flex items-center gap-6 text-sm">
              <Link href="/services" className="hover:opacity-90 no-underline">Services</Link>
              <Link href="/quote" className="hover:opacity-90 no-underline">Free Estimate</Link>
              <Link href="/book" className="btn bg-white text-brand-navy hover:bg-white/90">Book an Inspection</Link>
            </nav>
          </div>
        </header>
          ...
          <div className="mx-auto max-w-6xl px-4 py-8 grid md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div className="mt-1">
                ...
                <a className="underline" href="tel:+17738933356">(773) 893-3356</a>
              </div>
            </div>
            <div>
              <div className="font-semibold mb-1">Service Area</div>
              <div className="text-slate-200">Chicagoland & surrounding areas</div>
